        ...
        <header className="">
           <div className="flex-row-reverse md:flex justify-center items-center m-6 p-6">
            <div className="w-[40rem] h-auto mx-7">
                <h1 className="text-rose-300 lg:text-8xl md:text-4xl sm:text-2xl text-2xl">
            ...
            <div className="lg:mx-8 ">
                <img className="" src="https://i.ibb.co/NSd2cr2/27470334-7309681-removebg-preview.png"></img>
            </div>
            </div>
        </header>
    )
