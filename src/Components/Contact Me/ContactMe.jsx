      ...
      <div className="flex justify-center items-center">
        <div className="bg-zinc-300/40 flex h-96 w-[45rem] my-11 rounded-3xl p-9 text-white">
          <div className="leading-10 my-12 h-60 w-[35rem]">
            ...
            <p className="font-bold text-2xl drop-shadow-xl mt-12">
              Connect with me{" "}
            </p>
            <ul className="flex flex-row space-x-6 drop-shadow-xl">
              <li>
                <a
                  href="https://www.instagram.com/ayushtenguria"
                  target="_blank"
                >
                  <InstagramIcon />
                </a>
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/ayush-sharma-800853120/"
                  target="_blank"
                >
                  <LinkedInIcon />
                </a>
              ...
              <li>
                <a href="https://www.github.com/ayushtenguria" target="_blank">
                  <GitHubIcon />
                </a>
              </li>
              <li>
                <a href="mailto:hacktiger.as@gmail.com" target="_blank">
                  <MailIcon />
                </a>
              </li>
            </ul>
          ...
          <div className="justify-center ">
            ...
            <div className="flex flex-col my-4">
              ...
              >
                <input
                  className="h-10 rounded-3xl p-4"
                ...
                />
                <input
                  className="bg-blue-400 cursor-pointer drop-shadow-2xl active:border-b-0 active:border-r-0  rounded-2xl h-10 border-b-4 border-r-4 border-slate-800"
                  name="Name"
                  type="submit"
                />
              </form>
